...
<div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="container">
        ...
        <p align="left"><%=Booking.flight_id%> - <%=Booking.flight_name%> (Travellers <%=Search.persons%>)</p><br>
        <br>
        ...
        <h2 align="right"><strong>Total Paid- SAR.<%=Search.persons*Booking.ticket_price%></strong></h2><br><br>
    </div>
